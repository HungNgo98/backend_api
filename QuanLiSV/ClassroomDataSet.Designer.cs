...
namespace QuanLiSV.ClassroomDataSetTableAdapters {
    ...
    public partial class ClassroomTableAdapter : global::System.ComponentModel.Component {
        ...
        public virtual int Fill(ClassroomDataSet.ClassroomDataTable dataTable) {
        ...
        public virtual ClassroomDataSet.ClassroomDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ClassroomDataSet.ClassroomDataTable dataTable = new ClassroomDataSet.ClassroomDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ClassroomDataSet.ClassroomDataTable dataTable) {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Name], [Age], [Class], [Sex]) VALUES (@Name, @Age, " +
                "@Class, @Sex);\r\nSELECT id, Name, Age, Class, Sex FROM Student WHERE (id = SCOPE_" +
                "IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Name] = @Name, [Age] = @Age, [Class] = @Class, [Sex] = @Sex WHERE (([id] = @Original_id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Class = 1 AND [Class] IS NULL) OR ([Class] = @Original_Class)) AND ((@IsNull_Sex = 1 AND [Sex] IS NULL) OR ([Sex] = @Original_Sex)));
SELECT id, Name, Age, Class, Sex FROM Student WHERE (id = @id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT id, Name, Age, Class, Sex FROM dbo.Student";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_id, string Original_Name, global::System.Nullable<int> Original_Age, string Original_Class, string Original_Sex) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> Age, string Class, string Sex, int Original_id, string Original_Name, global::System.Nullable<int> Original_Age, string Original_Class, string Original_Sex, int id) {
            if ((Name == null)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> Age, string Class, string Sex, int Original_id, string Original_Name, global::System.Nullable<int> Original_Age, string Original_Class, string Original_Sex) {
            return this.Update(Name, Age, Class, Sex, Original_id, Original_Name, Original_Age, Original_Class, Original_Sex, Original_id);
        }
    }
